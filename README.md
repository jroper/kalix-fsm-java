...
```shell
> curl -XPOST -H "Content-Type: application/json" localhost:9000/com.example.kalixfsm.CounterService/GetCurrentCounter -d '{"counterId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"counterId": "foo"}' localhost:9000 com.example.kalixfsm.CounterService/GetCurrentCounter 
ERROR:
  Code: Unknown
